      ...
      if (isLogin) {
        ...
        try {
          ...
          if (!paymentConfig.configured) {
            throw new Error(
              "Payment system not configured. Add RAZORPAY_KEY_ID and RAZORPAY_KEY_SECRET to the backend .env file.",
            );
          }
              ...
              try {
                ...
                if (verifyResult.access_token && verifyResult.user) {
                  ...
                  localStorage.setItem(
                    "user",
                    JSON.stringify(verifyResult.user),
                  );
    ...
    <div className="min-h-screen bg-off-white relative">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        <div className="max-w-4xl mx-auto w-full px-6 md:px-8 lg:px-12 py-12 md:py-16">
          ...
          {error && (
            <div
              className="bg-red-50 border border-red-200 text-red-800 px-6 py-4 rounded mb-8 font-sans text-sm md:text-base"
          ...
          {!isLogin ? (
            <div className="max-w-2xl mx-auto space-y-12 md:space-y-16">
              ...
              <div className="space-y-8">
                <h2 className="font-serif font-semibold text-2xl md:text-3xl text-warm-black">
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <h3 className="font-sans font-semibold text-xl md:text-2xl text-warm-black mb-3">
                            {plan.name}
                          </h3>
                          <div className="flex items-baseline gap-2 mb-2">
                            <span className="font-sans font-semibold text-3xl md:text-4xl text-warm-black">
                              {plan.price}
                            </span>
                            <span className="font-sans text-base md:text-lg text-warm-black/50">
                              / {plan.period}
                            </span>
                          </div>
                          <p className="font-sans text-sm md:text-base text-warm-black/60">
                            {plan.note}
                          </p>
                        </div>
                        <div
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <Link
                      to="/forgot-password"
                      className="block text-sm text-accent-muted hover:text-accent-muted/80 font-medium mt-2"
